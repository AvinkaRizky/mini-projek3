	...
	<footer style="border-top: 4px solid #ff8680;  ">
		<div class="container" style="padding-bottom: 50px;">
			<div class="row">
				<div class="col-md-4">
					<h3 style="color: #ff8680"><b>Dreams Cake</b></h3>
					<p>Jl. MasaMasa</p>
					<p><i class="glyphicon glyphicon-earphone"></i> +628764256075</p>
					<p><i class="glyphicon glyphicon-envelope"></i> drcake@gmail.com</p>
				</div>
				<div class="col-md-4">
					<h5><b>Menu</b></h5>
